    ...
    if dirlst:
        if not searched:
            try:
                ...
                dirlst.append({'name': 'Next Page -->', 'url': url, 'mode': content_mode, 'icon': xbmc.translatePath(os.path.join('special://home/addons/script.adultflix.artwork', 'resources/art/main/next.png')), 'fanart': fanarts, 'description': 'Load More Videos...', 'folder': True})
            except: pass
